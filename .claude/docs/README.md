...
| Feature | Status | Docs |
| --- | --- | --- |
| Dot-line game (gameplay) | Specified, not implemented | [requirements](dot-line-game/requirements.md) · [design](dot-line-game/design.md) · [tasks](dot-line-game/tasks.md) |
