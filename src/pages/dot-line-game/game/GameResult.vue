  ...
  <div class="flex w-full flex-col gap-4 sm:w-53">
    <div class="flex flex-col gap-1">
      ...
      <div v-if="winner" class="flex items-center gap-2">
        ...
        <h3 class="min-w-0 truncate text-xl font-bold text-gray-900">{{ winner.name }} wins</h3>
      </div>
      <h3 v-else class="text-xl font-bold text-gray-900">Draw</h3>
...
const reason = computed(() =>
  props.dotLineGame.finishReason === 'stopped'
